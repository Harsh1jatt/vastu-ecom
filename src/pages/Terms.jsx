...
const termsSections = [
...

    {
        ...
        content: [
            `You agree and undertake to use the Website and the Service only to post and upload messages and material that are proper, and to carry out other lawful activities. When using a Service, you will not:`
        ],
        list: [
            ...
            `Violate any code of conduct or other guidelines applicable to any particular Service.`,
            `Violate any applicable laws or regulations for the time being in force in or outside India.`,
            `Violate any of the terms and conditions of this Agreement or any other terms and conditions for the use of the Website.`
        ]
    },
