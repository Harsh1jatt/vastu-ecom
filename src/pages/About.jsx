...
const About = () => (
  <>
    <SEO
      ...
      description={`Learn more about ${SITE_NAME}. We provide professional Vastu consultation, energy balancing solutions, Vastu remedies, and guidance for homes, offices, commercial properties, and industrial spaces.`}
      keywords="Vastu Consultant India, Online Vastu Consultation, Residential Vastu, Commercial Vastu, Office Vastu, Factory Vastu, Vastu Expert, Vastu Remedies, Energy Balancing Solutions, Vastu Divine"
      url="/about"
      type="website"
    />
